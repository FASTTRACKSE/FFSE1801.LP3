...
var apl1=new apl(
      ...
      "",
      "Viet Nam",
      "/assets/images/applicant/ava1.jpg",
      "079 208 3481",
...
var emp1=new emp(
      ...
      "/assets/images/employer/001/logo.png",
      ...
      "Là công ty tiên phong trong việc áp dụng những kỹ thuật tiên tiến nhất về thu thập và xử lý dữ liệu, Le Bonjour Job tự hào là nhà cung cấp giải pháp toàn diện về các vấn đề nhân sự, quản lý đội ngũ, tìm kiếm nhân tài. Chúng tôi tự tin sẽ luôn đáp ứng những đòi hỏi khắt khe nhất của bạn.",
      ['/assets/images/employer/001/banner1.jpg',
      '/assets/images/employer/001/banner2.jpg',
      '/assets/images/employer/001/banner3.jpg'],
      ['/assets/images/employer/001/activity/act1.jpg',
      '/assets/images/employer/001/activity/act2.jpg',
      '/assets/images/employer/001/activity/act3.jpg',
      '/assets/images/employer/001/activity/act4.jpg',
      '/assets/images/employer/001/activity/act5.jpg'],
...
var emp2=new emp(
      ...
      "/assets/images/employer/002/logo.jpeg",
      "25/07/2001",
      ...
      ['/assets/images/employer/002/banner1.jpg',
      '/assets/images/employer/002/banner2.jpg',
      '/assets/images/employer/002/banner3.jpg'],
      ['/assets/images/employer/002/activity/act1.jpg',
      '/assets/images/employer/002/activity/act2.jpg',
      '/assets/images/employer/002/activity/act3.jpg',
      '/assets/images/employer/002/activity/act4.jpg',
      '/assets/images/employer/002/activity/act5.jpg'],
      ['Chuyên viên marketing tại Đà Nẵng','Kế toán tổng hợp','Quản lý dự án','Chuyên viên tuyển dụng'],
      ['review 1','review 2','review 3'],
      ['User 1','User 2','User 3']
      )
...
var emp3=new emp(
      ...
      "/assets/images/employer/003/logo.png",
      "25/07/2001",
      ...
      ['/assets/images/employer/003/banner1.jpg',
      '/assets/images/employer/003/banner2.jpg',
      '/assets/images/employer/003/banner3.jpg'],
      ['/assets/images/employer/003/activity/act1.jpg',
      '/assets/images/employer/003/activity/act2.jpg',
      '/assets/images/employer/003/activity/act3.jpg',
      '/assets/images/employer/003/activity/act4.jpg',
      '/assets/images/employer/003/activity/act5.jpg'],
      ['Chuyên viên marketing tại Đà Nẵng','Kế toán tổng hợp','Quản lý dự án','Chuyên viên tuyển dụng'],
      ['review 1','review 2','review 3'],
      ['User 1','User 2','User 3']
      )
var emp4=new emp(
      ...
      "/assets/images/employer/004/logo.jpg",
      "25/07/2001",
      ...
      ['/assets/images/employer/004/banner1.jpg',
      '/assets/images/employer/004/banner2.jpg',
      '/assets/images/employer/004/banner3.jpg'],
      ['/assets/images/employer/004/activity/act1.jpg',
      '/assets/images/employer/004/activity/act2.jpg',
      '/assets/images/employer/004/activity/act3.jpg',
      '/assets/images/employer/004/activity/act4.jpg',
      '/assets/images/employer/004/activity/act5.jpg'],
      ['Chuyên viên marketing tại Đà Nẵng','Kế toán tổng hợp','Quản lý dự án','Chuyên viên tuyển dụng'],
      ['review 1','review 2','review 3'],
      ['User 1','User 2','User 3']
      )
...
var art1=new article(
      ...
      "30/10/2018",
      "Khoa Do",
      "/assets/images/articles/camnang.png",
      "30",
      "Good!"
      )
...
var event4=new event(
      ...
      "29/11/2018",
      "3",
      "/assets/images/events/event4.jpg",
      "150",
      "200",
      "Miễn phí",
...
var event5=new event(
      ...
      "30/11/2018",
      "3",
      "/assets/images/events/event5.jpg",
      "100",
      "300",
      "Miễn phí",
                  ...
                  `<div class='row bg-light p-3 mx-auto col-md-6 border-bottom border-bottom-secondary jobcard rounded'>
                        <img class='mr-3 col-2 logo' src='`+ empList[jobArr[i].empID].logo +`' alt='Generic placeholder image'>
                              <div class='col-6 pr-0'>
                                    ...
                                    <a href='/templates/employer/job_description.php'>`+ jobArr[i].title +`</a>
                                    </h5>
                                    <h6 class='truncate'>
                                    <a href='/templates/employer/employer_profile.php'>`+ empList[jobArr[i].empID].name +`</a>
                                    </h6>
                                    <div class=''>
...
function jobCardSlim(jobObj,position){
            ...
            for (var i=0;i<3;i++){
                  ...
                  <div class="media-body jobcard bg-light rounded px-3 py-2 my-3">
                        <h5 class="mt-0 "><a href="/templates/employer/job_description.php">`+jobObj.title+`</a></h5>
...
function vipCard(empArr,position,quantity1,quantity2){
            ...
            for (var i=0;i<quantity;i++){
                  ...
                  <div class='card employer__vip' id='event`+empArr[i].id+`'>
                        ...
                        <div class='card-body py-2'>
                              <a href='/templates/employer/employer_profile.php'>
      ...
      function hiring(params,hirings) {
            ...
            for(let i=0;i<hirings;i++){
                  str += `<li class='list-group-item p-1 text-truncate'><a href='/templates/shared/main_job.php'>`+params[i]+`</a></li>`
            };
            return  str;
      }
                  ...
                  <div class="card event__card">
                        ...
                        <div class="row">
                              <div class="col-md-8 pl-5 pb-4">
                                    <a href="/templates/shared/constructing.php" title="`+eventArr[i].title+`">
                                          <h5 class="card-title text-left text-truncate">`+eventArr[i].title+`</h5>
                                    </a>
                                    <a href="/templates/employer/employer_profile.php" title="`+eventArr[i].host+`">
